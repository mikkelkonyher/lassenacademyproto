 ...
 * ("Nyeste Kurser") followed by a responsive instructor grid. Courses are
 * fetched from Supabase; each card links to /courses/:slug. The instructor
 * grid is still rendered from a hardcoded array (separate migration).
 */
...
export default function FeaturedSection() {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-64 -mt-64 w-[600px] h-[600px] bg-primary/8 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 -ml-64 -mb-64 w-[600px] h-[600px] bg-accent/8 rounded-full blur-3xl pointer-events-none"></div>
                  ...
                  {courses.map((course, idx) => {
                    ...
                    return (
                      <Link
                        ...
                        className="flex-shrink-0 rounded-2xl border border-white/20 hover:border-primary/60 transition-all duration-500 group overflow-hidden hover:shadow-2xl hover:shadow-primary/50 hover:-translate-y-2 relative cursor-pointer"
                        style={{
