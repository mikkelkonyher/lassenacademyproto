...
export const translations = {
  da: {
    ...
    footer: {
      description: 'Din vej til musikalsk mesterskab. Vi hjælper dig med at nå dine mål gennem struktureret undervisning og et støttende fællesskab.',
      partOf: 'En del af',
      explore: 'Udforsk',
      community: 'Fællesskab',
      contact: 'Kontakt',
  ...
  en: {
    ...
    footer: {
      description: 'Your path to musical mastery. We help you reach your goals through structured education and a supportive community.',
      partOf: 'Part of',
      explore: 'Explore',
      community: 'Community',
      contact: 'Contact',
