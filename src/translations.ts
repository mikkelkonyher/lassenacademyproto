...
export const translations = {
  da: {
    ...
    auth: {
      ...
      loginButton: "Log ind",
      // Login error messages — mapped from Supabase auth errors
      loginErrorInvalid: "Forkert email eller adgangskode. Prøv igen.",
      loginErrorUnconfirmed: "Din email er ikke bekræftet endnu. Tjek din indbakke for bekræftelseslinket.",
    ...
    contactPage: {
      ...
      errorMessage: "Beskeden kunne ikke sendes. Prøv venligst igen senere.",
      invalidEmail: "Indtast venligst en gyldig emailadresse.",
      requiredFields: "Udfyld venligst alle felter.",
      spamDetected: "Din besked blev markeret som spam. Ret den venligst og prøv igen.",
      info: {
        emailTitle: "Email",
    ...
    myProfile: {
      ...
      settings: {
        ...
        dangerTitle: "Slet konto",
        dangerWarning: "Når du sletter din konto, fjernes alt permanent: adgang til købte kurser, dit afspilningsforløb, din ønskeliste samt dine indlæg og kommentarer i fællesskabet. Dette kan ikke fortrydes.",
        deleteAccountButton: "Slet min konto",
        deleteModalTitle: "Er du helt sikker?",
        deleteModalBody: "Bekræft med din adgangskode for at slette din konto permanent.",
        deletePasswordLabel: "Adgangskode",
        deleteConfirmButton: "Slet permanent",
        deleteCancelButton: "Annuller",
        deleteWrongPassword: "Adgangskoden er forkert.",
        deleteError: "Kontoen kunne ikke slettes. Prøv igen.",
      },
    },
    newsPage: {
      navLabel: "Nyheder",
  ...
  en: {
    ...
    auth: {
      ...
      loginErrorUnconfirmed: "Your email isn't confirmed yet. Check your inbox for the confirmation link.",
    ...
    contactPage: {
      ...
      errorMessage: "Your message couldn't be sent. Please try again later.",
      invalidEmail: "Please enter a valid email address.",
      requiredFields: "Please fill in all fields.",
      spamDetected: "Your message was flagged as spam. Please revise it and try again.",
      info: {
        emailTitle: "Email",
    ...
    myProfile: {
      ...
      settings: {
        ...
        dangerWarning: "Deleting your account permanently removes everything: access to purchased courses, your watch progress, your watchlist, and your community posts and comments. This cannot be undone.",
        deleteAccountButton: "Delete my account",
        deleteModalTitle: "Are you absolutely sure?",
        deleteModalBody: "Confirm with your password to permanently delete your account.",
        deletePasswordLabel: "Password",
        deleteConfirmButton: "Delete permanently",
        deleteCancelButton: "Cancel",
        deleteWrongPassword: "Password is incorrect.",
